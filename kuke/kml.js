...
async function process_albums() {
  let sql =
    `select c.row_id,c.catalogue_id as album_id,c.catalogue_name as album_name, c.catalogue_cname as album_cname,
            concat('https://image.kuke.com/images/audio/cata200/',left(c.catalogue_id,1),'/', c.catalogue_id,'.jpg') as album_cover,
     ...
     from catalogue as c
              inner join (select row_id from catalogue where showable=1 limit ?,?) b on c.row_id=b.row_id
